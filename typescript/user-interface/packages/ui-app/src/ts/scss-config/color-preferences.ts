...
const variables = require('~css/gms-colors.scss');
...
export const semanticColors: SemanticColors = {
  ...
  waveformIntervalBoundry: variables.waveformIntervalBoundry,
