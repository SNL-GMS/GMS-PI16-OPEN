...
import { SaveableItem } from '@gms/ui-core-components/lib/components/dialog/types';
  ...
  private configureGoldenLayout() {
    ...
    this.gl.on('itemCreated', e => {
      if (e.config.component && Displays.isValidDisplayName(e.config.component)) {
        ...
        this.props.setGlDisplayState(e.config.component, CommonWorkspaceTypes.GLDisplayState.OPEN);
      }
    });
    this.gl.on('itemDestroyed', e => {
      if (e.config.component && Displays.isValidDisplayName(e.config.component)) {
        // update redux store to indicate that a display has been closed.
        this.props.setGlDisplayState(
          e.config.component,
          CommonWorkspaceTypes.GLDisplayState.CLOSED
        );
      }
    });
