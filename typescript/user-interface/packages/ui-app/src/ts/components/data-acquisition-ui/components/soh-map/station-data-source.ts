import { CommonTypes, ProcessingStationTypes, SohTypes } from '@gms/common-model';
import {
  BillboardGraphics,
  Cartesian3,
  Color,
 ...
 *
 * @param stations processing station list
...
export const mapStationsToSohEntities = (
  ...
  return stationSoh.map((stationAsSoh: SohTypes.UiStationSoh) => {
    ...
    currentEntity.billboard.image = stationTriangleWhite;
