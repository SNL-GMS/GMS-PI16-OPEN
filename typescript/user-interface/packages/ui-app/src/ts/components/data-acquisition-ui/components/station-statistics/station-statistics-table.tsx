...
> {
   ...
   */
  private readonly channelLagValueGetter: NumberValueGetter = this.buildNumberValueGetter<number>(
   ...
   * @param params the value getter params
   */
  private readonly stationLagValueGetter: NumberValueGetter = this.buildNumberValueGetter<number>(
   ...
   * @param params the value getter params
   */
  private readonly stationNameValueGetter: StringValueGetter = this.buildStringValueGetter<string>(
   ...
   */
  public readonly updateColumnVisibility = (state: Map<Columns, boolean>): void => {
   ...
   */
  private buildNumberValueGetter<T extends number>(getter: (d: StationStatisticsRow) => T) {
  ...
  private buildStringValueGetter<T extends string>(getter: (d: StationStatisticsRow) => T) {
    return (params: StringCellRendererParams): T => {
      const data = this.props.tableData.find(d => d.id === params.data.id);
      return data && getter(data);
    };
  }
