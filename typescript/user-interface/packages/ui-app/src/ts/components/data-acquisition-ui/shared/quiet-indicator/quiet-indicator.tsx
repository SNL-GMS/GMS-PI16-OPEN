...
import { QuietIndicatorProps, QuietIndicatorWithTooltipProps, QuietTimingInfo } from './types';

const quietTimerIsActive = (quietTimingInfo: QuietTimingInfo) =>
  Date.now() < quietTimingInfo.quietUntilMs;

const BaseQuietIndicator: React.FunctionComponent<QuietIndicatorProps> = props => {
