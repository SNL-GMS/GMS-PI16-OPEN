...
import { EnvironmentCellValueProps } from './types';
 ...
 */
export const EnvironmentCellValue: React.FunctionComponent<EnvironmentCellValueProps> = ({
  ...
  return (
    <div className="table-cell__value table-cell__value--numeric" data-cy="environment-cell">
      {hasUnacknowledgedChanges ? (
        <Icon icon={IconNames.SYMBOL_CIRCLE} className="env-dirty-dot" />
      ) : null}
