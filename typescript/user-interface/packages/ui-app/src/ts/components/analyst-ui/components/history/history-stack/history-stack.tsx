...
import { CacheTypes, EventTypes } from '@gms/common-model';
import React from 'react';

import { HistoryContext, HistoryContextData } from '../types';
import {
...
export class HistoryStack extends React.Component<HistoryStackProps, HistoryStackState> {
  ...
  // eslint-disable-next-line react/static-property-placement
  public context: React.ContextType<typeof HistoryContext>;
  ...
  private isEventCompleted(id: string): boolean {
    ...
    return theEvent && theEvent.status === EventTypes.EventStatus.Complete;
  }
