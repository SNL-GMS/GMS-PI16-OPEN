...
export const columnDefs: ColumnDefinition<SignalDetectionsRow, any, any, any, any>[] = [
  {
    headerName: '',
    field: 'modified',
    ...
    sortable: true,
    filter: true,
    cellRendererFramework: ModifiedDot as any
  },
  {
    ...
    sortable: true,
    filter: true,
    cellRendererFramework: DetectionColorCellRenderer as any
  },
  {
    headerName: 'Time',
    field: 'time',
  ...
  },
  {
    headerName: 'Azimuth (\u00B0)',
    field: 'azimuth',
    tooltipValueGetter: () => 'Receiver to Source Azimuth (\u00B0)',
    editable: false,
    resizable: true,
    sortable: true,
    filter: true,
  ...
  },
  {
    headerName: 'Conflict',
    field: 'conflicts',
    cellRendererFramework: SignalDetectionConflictMarker as any,
    width: 30,
    resizable: true,
    sortable: true,
    filter: true,
