...
import { AlignWaveformsOn } from '../../components/waveform/types';
        ...
        <div className="alignment-dropdown__row">
          ...
          >
            {this.state.alignedOn === AlignWaveformsOn.TIME ? (
              ...
              <Radio label="Time" value="time" key="time" className="alignment-dropdown__radio" />
            )}
            <Radio label="Phase" value="phase" key="phase" className="alignment-dropdown__radio" />
          </RadioGroup>
          <div className="alignment-dropdown__phase-type-selector">
            <DropDown
              value={this.state.alignedOn}
