...
const ScalingOptionSelector: React.FC<ScalingOptionsSelectorProps> = ({
  ...
  return (
    ...
    >
      <Radio label="Auto scale" value={AmplitudeScalingOptions.AUTO} />
      <Radio label="Fix scale to:" value={AmplitudeScalingOptions.FIXED}>
        <HTMLSelect
          disabled={false}
          onChange={e => {
 ...
 */
const buildScalingOptionSelector = (
  rank: number,
  ampScaleOption: AmplitudeScalingOptions,
  fixedScaleOptions: FixedScaleValue[],
  fixedScaleVal: FixedScaleValue,
...
export const useScalingOptions = (
  ...
  toolbarItem: ToolbarTypes.CustomItem;
  ampScaleOption: AmplitudeScalingOptions;
  fixedScaleVal: FixedScaleValue;
} => {
  const pacQuery = useProcessingAnalystConfigurationQuery();
  ...
  return {
    toolbarItem: React.useMemo<ToolbarTypes.CustomItem>(
      () =>
        buildScalingOptionSelector(
          rank,
      ...
      [rank, amplitudeScaleOption, fixedScaleVal, scaleValues, setAmpScaleOption, setFixedScaleVal]
    ),
    ampScaleOption: amplitudeScaleOption,
    fixedScaleVal
  };
};
