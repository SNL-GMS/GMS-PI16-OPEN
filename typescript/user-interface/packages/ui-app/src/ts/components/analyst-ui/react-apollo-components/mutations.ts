 ...
 */
export function graphqlUndoHistoryMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRedoHistoryMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUndoHistoryByIdMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRedoHistoryByIdMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUndoEventHistoryMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRedoEventHistoryMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUndoEventHistoryByIdMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRedoEventHistoryByIdMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlCreateEventMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUpdateEventsMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlSaveEventMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUpdateFeaturePredictionsMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlLocateEventMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlComputeFksMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlMarkFksReviewedMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlCreateQcMaskMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUpdateQcMaskMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRejectQcMaskMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlCreateDetectionMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlUpdateDetectionsMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlRejectDetectionsMutation<T extends BaseProps>(withRef = false) {
 ...
 * @returns the wrapped component
 */
export function graphqlMarkAmplitudeMeasurementReviewed(withRef = false) {
...
export function updateApolloCacheFromDataPayload(
  ...
  if (eventIdsUpdated && eventIdsUpdated.length > 0) {
    ...
    const eventsTimeRange = systemConfig.getEventsTimeRange(currentTimeInterval, analysisMode);
  ...
  if (payload.qcMasks && payload.qcMasks.length > 0) {
    ...
    const qcMasksTimeRange = systemConfig.getDefaultTimeRange(currentTimeInterval, analysisMode);
    ...
    payload.qcMasks
      .filter(
        qcMask =>
          qcMask.currentVersion.endTime >= qcMasksTimeRange.startTimeSecs &&
          qcMask.currentVersion.startTime <= qcMasksTimeRange.endTimeSecs
      )
      .forEach(qcMask => {
        const index = qcMasksByChannelName.findIndex(mask => mask.id === qcMask.id);
        if (index >= 0) {
          qcMasksByChannelName[index] = qcMask;
        } else {
          qcMasksByChannelName.push(qcMask);
        }
      });
