...
/** Initial Mag type */
const initialMagType: AnalystWorkspaceTypes.DisplayedMagnitudeTypes = Immutable.Map<any, boolean>([
...
export const userPreferences: UserPreferences = {
  ...
  location: {
    preferredLocationSolutionRestraintOrder: [
      EventTypes.DepthRestraintType.UNRESTRAINED,
      EventTypes.DepthRestraintType.FIXED_AT_SURFACE,
