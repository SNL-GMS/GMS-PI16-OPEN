...
export const getAmplitudesByStation = (
  ...
  const amplitudesByStation: AmplitudesByStation[] = stations.map(station => ({
    ...
    magTypeToAmplitudeMap: new Map<EventTypes.MagnitudeType, StationMagnitudeSdData>(),
    validSignalDetectionForMagnitude: new Map<EventTypes.MagnitudeType, boolean>()
  }));
