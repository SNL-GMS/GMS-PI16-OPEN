...
import { ColumnGroupDefinition } from '@gms/ui-core-components';
 ...
 */
function getValueFromParams(params, magnitudeType: EventTypes.MagnitudeType, key: string) {
    ...
    children: [
      {
        ...
        hide: !displayedMagnitudeTypes.get(magnitudeType),
        magnitudeType,
        cellStyle: params => ({
          'text-align': 'left',
          color: params.data.historicalMode ? historicalColor : undefined,
...
export function generateStationMagnitudeColumnDefs(
  defStatesForMagnitudeType: Map<EventTypes.MagnitudeType, MagDefiningStates>,
  stationIdsForMagnitudeType: Map<EventTypes.MagnitudeType, string[]>,
  displayedMagnitudeTypes: AnalystWorkspaceTypes.DisplayedMagnitudeTypes,
  ...
  const magnitudeHeaderGroups: ColumnGroupDefinition[] = Object.keys(
    ...
    generateMagnitudeColumn(
      EventTypes.MagnitudeType[key],
      systemConfig.amplitudeTypeForMagnitude.get(EventTypes.MagnitudeType[key]),
      defStatesForMagnitudeType.get(EventTypes.MagnitudeType[key]),
      displayedMagnitudeTypes,
      stationIdsForMagnitudeType.get(EventTypes.MagnitudeType[key]),
      definingCallback
    )
  );
