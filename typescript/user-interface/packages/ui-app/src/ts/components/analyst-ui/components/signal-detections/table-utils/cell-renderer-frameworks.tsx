 ...
 */
export class DetectionColorCellRenderer extends React.PureComponent<any> {
 ...
 */
export class ModifiedDot extends React.PureComponent<any> {
  public render(): JSX.Element {
    return (
      <Tooltip
 ...
 * Renders the modified color cell for the signal detection list
 */
export class SignalDetectionConflictMarker extends React.PureComponent<any> {
  public render(): JSX.Element {
