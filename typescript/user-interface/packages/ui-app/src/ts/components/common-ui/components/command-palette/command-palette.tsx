...
import { CommandPaletteContext, CommandPaletteContextData } from './command-palette-context';
import { CommandPaletteSearchManager } from './command-palette-search-manager';
import { CommandPaletteProps, CommandPaletteState } from './types';
...
export class CommandPalette extends React.Component<CommandPaletteProps, CommandPaletteState> {
  ...
  // eslint-disable-next-line react/static-property-placement
  public context: React.ContextType<typeof CommandPaletteContext>;
