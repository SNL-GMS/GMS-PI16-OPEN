...
import { DateTimeFormat, epochSecondsNow } from '@gms/common-util';
...
const buildTimePicker = (
  ...
  rank: number,
  durations?: ToolbarTypes.DateRangePickerTypes.DurationOption[],
  minStartTimeMs?: number,
  maxEndTimeMs?: number,
  format?: DateTimeFormat
): ToolbarTypes.DateRangePickerItem => ({
  label,
  tooltip,
 ...
 * @returns an array containing a time range and time picker in the format: [TimeRange, ToolbarTypes.ToolbarItem]
 */
export const useTimePicker = (
  ...
  format?: DateTimeFormat
): [CommonTypes.TimeRange, ToolbarTypes.DateRangePickerItem] => {
