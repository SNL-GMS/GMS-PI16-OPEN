...
import { CommandPaletteInputProps } from './types';
 ...
 */
export const CommandPaletteInput: React.FunctionComponent<CommandPaletteInputProps> = props => {
  // eslint-disable-next-line @typescript-eslint/unbound-method
  const { setSearchTerm, getSearchTerm } = props;
  ...
  return (
    <InputGroup
      ...
      onKeyDown={(e: React.KeyboardEvent) => {
        ...
        if (e.key === 'ArrowUp') {
          e.preventDefault();
          props.selectionManager.selectPrevious();
        }
        if (e.key === 'ArrowDown') {
          e.preventDefault();
          props.selectionManager.selectNext();
        }
      }}
