...
import { Command, SearchableCommandPaletteProps } from './types';
 ...
 */
export const CommandPaletteSearchManager: React.FunctionComponent<SearchableCommandPaletteProps> = props => {
