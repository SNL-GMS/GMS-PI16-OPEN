...
export const SoundConfigurationCellRenderer: React.FunctionComponent<SoundConfigurationRendererParams> = (
  props: SoundConfigurationRendererParams
) => (
  <TableCellRenderer
    data-col-position={getColumnPosition(props)}
...
export const SoundConfigurationDropdownRenderer: React.FunctionComponent<SoundConfigurationRendererParams> = (
  props: SoundConfigurationRendererParams
) => {
