...
import { UiStationSoh } from '@gms/common-model/lib/soh/types';
...
import { StationStatisticsProps } from '../../../../../src/ts/components/data-acquisition-ui/components/station-statistics/types';
...
describe('Station Statistics Component', () => {
  ...
  const stationStatisticsComponent = Enzyme.shallow(
  ...
  it('can shallow render', () => {
    expect(stationStatisticsComponent).toMatchSnapshot();
  });
