...
import {
  ...
  GetWaveformParams,
  setGlobalDomain
} from '../../../../src/ts/workers/waveform-worker/operations/get-waveform';
...
describe('getWaveform', () => {
  ...
  it('get Position Buffer with bad time range', async () => {
    ...
    WaveformStore.store(badParams.id, wavePromise);
  ...
  it('get Position Buffer should return partial buffer', async () => {
    ...
    WaveformStore.store(partialParams.id, wavePromise);
  ...
  it('get Position Buffer should return empty buffer', async () => {
    ...
    WaveformStore.store(emptyParams.id, wavePromise);
