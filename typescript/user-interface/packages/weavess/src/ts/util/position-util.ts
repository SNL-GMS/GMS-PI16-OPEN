...
import { PositionPercentRange } from '../components/waveform-display/components/measure-window/measure-window-selection/measure-window-selection-area/types';
...
export const getMeasureWindowSelectionAreaFraction = (
  ...
  return {
    startPercent: scale(timeRange.startTimeSecs) * 100,
    endPercent: scale(timeRange.endTimeSecs) * 100
  };
};
