...
import { MoveableMarkerProps } from '../../../../../../src/ts/components/waveform-display/components/markers/moveable-marker/types';
...
const props: MoveableMarkerProps = {
  ...
  viewTimeRange: () => ({ startTimeSecs: 0, endTimeSecs: 1000 }),
...
describe('Weavess Moveable Marker', () => {
  ...
  it('shallow renders', () => {
    const shallow = Enzyme.shallow(<MoveableMarker {...props} />);
  ...
  it('getMinConstraintPercentage', () => {
    ...
    expect(spy).toBeCalled();
    expect(instance.getMinConstraintPercentage()).toEqual(1.6);
  });
  ...
  it('getMaxConstraintPercentage', () => {
    ...
    expect(spy).toBeCalled();
    expect(instance.getMaxConstraintPercentage()).toEqual(59.9);
  });
