 ...
 */
const ellipsis = (str: string, length = 500) =>
...
export class HttpMockWrapper {
   ...
   */
  // eslint-disable-next-line @typescript-eslint/explicit-module-boundary-types, @typescript-eslint/no-explicit-any, consistent-return
...
export class HttpClientWrapper {
  ...
  public createHttpMockWrapper(): HttpMockWrapper {
    this.mockAdaptor = new HttpMockWrapper();
    return this.mockAdaptor;
  }
}
