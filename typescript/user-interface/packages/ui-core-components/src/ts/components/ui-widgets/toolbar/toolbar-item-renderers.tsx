 ...
 */
export const renderDropdown = (dropdownItem: ToolbarTypes.DropdownItem): JSX.Element => (
...
export const renderNumeric = (numericItem: ToolbarTypes.NumericInputItem): JSX.Element => (
...
export const renderIntervalPicker = (
  intervalItem: ToolbarTypes.IntervalPickerItem
): JSX.Element => (
  <div
...
export const renderDateRangePicker = (
  intervalItem: ToolbarTypes.DateRangePickerItem
): JSX.Element => (
  <div
    className="toolbar-button--capsule"
    key={intervalItem.rank}
...
export const renderPopoverButton = (
  popoverItem: ToolbarTypes.PopoverItem,
  addToPopoverMap: any
): JSX.Element => (
...
export const renderButton = (
  buttonItem: ToolbarTypes.ButtonItem,
  marginRight?: number
): JSX.Element => {
...
export const renderSwitch = (switchItem: ToolbarTypes.SwitchItem): JSX.Element => (
  <div
...
export const renderButtonGroup = (groupItem: ToolbarTypes.ButtonGroupItem): JSX.Element => {
...
export const renderLoadingSpinner = (spinnerItem: ToolbarTypes.LoadingSpinnerItem): JSX.Element => (
