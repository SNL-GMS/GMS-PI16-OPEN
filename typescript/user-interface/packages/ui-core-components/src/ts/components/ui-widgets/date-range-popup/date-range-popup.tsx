...
import { DateRangePopupProps, DurationOption } from './types';
...
export const DateRangePopup: React.FunctionComponent<DateRangePopupProps> = (
  ...
  const timePrecision = format.includes(TIME_FORMAT_WITH_FRACTIONAL_SECOND_PRECISION)
    ? TimePrecision.MILLISECOND
    : // eslint-disable-next-line no-nested-ternary
    format.includes(TIME_FORMAT_WITH_SECOND_PRECISION)
    ? TimePrecision.SECOND
    : format.includes(TIME_FORMAT)
