        ...
        <div>
          <div>
            ...
            <p>
              ...
              browser. Otherwise, peruse the source code for ideas on how to use the components in
              UI Core Components.
            </p>
            <H3>Documentation</H3>
          ...
          <div>
            ...
            <p>
              A form that does not accept input, but uses form features such as showing extra
              content and having multiple panels.
            </p>
            <H4>
              <Icon icon={IconNames.APPLICATION} />
