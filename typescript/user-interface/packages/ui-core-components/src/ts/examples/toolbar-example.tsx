...
import { Toolbar, ToolbarTypes } from '../components';
...
export class ToolbarExample extends React.Component<unknown, ToolbarExampleState> {
  ...
  public render(): JSX.Element {
    ...
    const items: ToolbarTypes.ToolbarItem[] = [];
    const numericInput: ToolbarTypes.NumericInputItem = {
      rank: 1,
    ...
    const popoverItem: ToolbarTypes.PopoverItem = {
      rank: 3,
    ...
    const buttonItemWithIcon: ToolbarTypes.ButtonItem = {
      rank: 4,
    ...
    const iconButton: ToolbarTypes.ButtonItem = {
      rank: 5,
      type: ToolbarTypes.ToolbarItemType.Button,
      label: 'Just an icon',
    ...
    const switchItem: ToolbarTypes.SwitchItem = {
      label: 'On/Off',
