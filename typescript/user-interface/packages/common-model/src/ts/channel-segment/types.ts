...
import { VersionReference } from '../faceted';
import { Channel } from '../station-definitions/channel-definitions/channel-definitions';
...
export interface ChannelSegmentDescriptor {
  readonly channel: Channel | VersionReference<Channel>;
