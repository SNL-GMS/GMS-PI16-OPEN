...
// Cyclical nature of architecture means that Channels can have Stations, and Stations can have Channels.
...
export interface Station extends Faceted {
  ...
  effectiveAt: number;
  effectiveUntil: number;
  relativePositionsByChannel: Map<string, RelativePosition>;
  location: Location;
