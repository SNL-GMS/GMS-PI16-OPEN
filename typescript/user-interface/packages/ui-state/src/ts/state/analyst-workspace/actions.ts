...
const setWaveformClientLoadingState: ActionCreator<WaveformClientState> = actionCreator(
  ActionTypes.SET_WAVEFORM_CLIENT_LOADING_STATE
);

const setWaveformClient: ActionCreator<WaveformClient> = actionCreator(
  ActionTypes.SET_WAVEFORM_CLIENT
);
