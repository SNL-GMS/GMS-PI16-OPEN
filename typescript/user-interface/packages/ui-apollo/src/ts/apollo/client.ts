...
export const createApolloClientConfiguration = (
  url: string = graphqlProxyUri
    ? `${graphqlProxyUri}/interactive-analysis-api-gateway/graphql`
    : undefined,
  ws: string = subscriptionsProxyUri
    ? `${subscriptionsProxyUri}/interactive-analysis-api-gateway/subscriptions`
    : undefined
