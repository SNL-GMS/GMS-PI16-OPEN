import { CommonMutations, ConfigurationQueries } from '@gms/common-graphql';
...
export class UILogger {
  ...
  public static Instance(): UILogger {
  ...
  public setClient(client: Client | undefined): void {
    ...
    this.getLogLevelConfiguration(client)
      ...
      .catch(error => {
        ...
        console.warn(`Failed to get log level configuration ${error}`);
      });
  }
      ...
      if (this.client) {
        ...
        if (this.shouldLogMessageForLogLevel(logLevel)) {
          ...
          if (messagesToLog && messagesToLog.length > 0) {
            ...
            // eslint-disable-next-line @typescript-eslint/no-floating-promises
            this.clientLogMutation(this.client, variables).catch(e => {
