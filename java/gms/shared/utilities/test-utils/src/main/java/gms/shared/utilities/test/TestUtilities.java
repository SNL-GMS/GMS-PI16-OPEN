...
public class TestUtilities {
   ...
   */
  public static <T> T testSerialization(T object, Class<T> type)
      throws IOException {
    return testSerialization(object, type, ObjectMapperFactory.getJsonObjectMapper());
  }
   ...
   * @throws IOException if serialization/deserialization fails
   */
  public static <T> T testSerialization(T object, Class<T> type, ObjectMapper objMapper)
      throws IOException {
