...
public class CoiLoaderApplication {
  ...
  public static void main(String[] commandLineArgs) {
    try {
      ...
      final OsdRepositoryInterface osd = args.getUseService() ?
          ClientGenerator.createClient(OsdRepositoryInterface.class)
          : OsdRepositoryFactory.createOsdRepository(SystemConfig.create("coi-loader"));
  ...
  private static CoiLoaderArgs loadAndValidateArgs(String[] commandLineArgs) {
    ...
    try {
      ...
      logger.error("Invalid args: ", ex);
      parser.printUsage(System.err);
      throw new RuntimeException("Loader failed", ex);
    }
  }
