...
@Testcontainers
public class ReferenceStationRepositoryJpaTests extends SohDbTest {
  ...
  void testStoringStationsTwiceWillThrowException() {
    RuntimeException ex = assertThrows(RuntimeException.class, () -> referenceStationRepositoryJpa.storeReferenceStation(
        List.of(TestFixtures.JNU_V1, TestFixtures.JNU_V2, TestFixtures.JNU_V3)));
    assertEquals(DataExistsException.class, ex.getCause().getClass());
  }

  @Test
  public void retrieveStationsTestGivenEmptyList() {
  ...
  @Test
  public void retrieveStationsTestGivenNonEmptyList() {
  ...
  @Test
  public void retrieveStationsByNameTestGivenNonEmptyList() {
  ...
  @Test
  public void retrieveStationsByNameTest() {
  ...
  @Test
  public void retrieveStationsByEntityIdTest() {
  ...
  @Test
  public void retrieveStationMembershipsByStationIdTest() {
  ...
  @Test
  public void retrieveStationMembershipsBySiteIdTest() {
  ...
  @Test
  public void retrieveStationMembershipsByStationAndSiteIdTest() {
    ...
    assertTrue(memberships.isEmpty());
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationAndSiteId(ReferenceStationMembershipRequest.create(stationId, TestFixtures.UNKNOWN_ID));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
    memberships = referenceStationRepositoryJpa
        .retrieveStationMembershipsByStationAndSiteId(ReferenceStationMembershipRequest.create(TestFixtures.UNKNOWN_ID, siteId));
    assertNotNull(memberships);
    assertTrue(memberships.isEmpty());
  }
