...
public abstract class OsdRepository implements OsdRepositoryInterface {
   ...
   */
  @Override
  public List<RawStationDataFrameMetadata> retrieveRawStationDataFrameMetadataByStationAndTime(StationTimeRangeRequest request) {
  ...
  public void storeAnalogAceis(Collection<AcquiredChannelEnvironmentIssueAnalog> analogAceis) {
    getStationSohRepository().storeAnalogAceis(analogAceis);
  }

  @Override
  public void storeBooleanAceis(Collection<AcquiredChannelEnvironmentIssueBoolean> booleanAceis) {
    getStationSohRepository().storeBooleanAceis(booleanAceis);
  }
  ...
  @Override
  public List<AcquiredChannelEnvironmentIssueAnalog> findLatestAnalogAcei(
      String placeholder) {
    return getStationSohRepository().findLatestAnalogAcei(placeholder);
  }

  @Override
  public List<AcquiredChannelEnvironmentIssueBoolean> findLatestBooleanAcei(
      String placeholder) {
    return getStationSohRepository().findLatestBooleanAcei(placeholder);
  }
  ...
  public Map<String, NavigableMap<Instant, AcquiredChannelEnvironmentIssueBoolean>> findBooleanAceiLatestBefore(
    ...
    return getStationSohRepository().findBooleanAceiLatestBefore(request);
  }

  @Override
  public Map<String, NavigableMap<Instant, AcquiredChannelEnvironmentIssueBoolean>> findBooleanAceiEarliestAfter(
      ChannelTimeAceiTypeRequest request) {
    return getStationSohRepository().findBooleanAceiEarliestAfter(request);
  }
