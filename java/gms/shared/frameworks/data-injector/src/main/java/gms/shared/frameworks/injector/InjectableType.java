...
public enum InjectableType {
  ...
  SYSTEM_MESSAGE(SystemMessage.class, SystemMessageModifier.class),
  STATION_SOH_ID(StationSoh.class, StationSohIdModifier.class),
  UI_STATION_AND_STATION_GROUPS(UiStationAndStationGroups.class, UiStationAndStationGroupsModifier.class),
