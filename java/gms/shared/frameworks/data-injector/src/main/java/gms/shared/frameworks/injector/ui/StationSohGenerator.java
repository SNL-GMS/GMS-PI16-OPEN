...
public class StationSohGenerator {
  ...
  private void generateMockStations() {
    ...
    for (Station station : this.stations) {
      final MockStationSOH newStation = new MockStationSOH(
          station,
   ...
   * @return updatedList
   */
  public List<StationSoh> getUpdatedStations() {
    final ArrayList<StationSoh> updatedList = new ArrayList<>();
  ...
  private StationSoh createStationSohAtCurrentTime(MockStationSOH mockStationSoh) {
    ...
    final Station station = mockStationSoh.getStation();
    ...
    StationSoh stationSoh = StationSoh.create(
        Instant.now(),
        station.getName(),
        sohMonitorValueAndStatuses,
        envStatusRollup,
  ...
  private Stream<SohMonitorValueAndStatus<Double>> createChannelEnvironmentStatuses() {
    ...
    double randomStatus = rand.nextDouble();
