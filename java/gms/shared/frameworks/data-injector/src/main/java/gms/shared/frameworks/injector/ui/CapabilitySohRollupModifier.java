...
import gms.shared.frameworks.osd.coi.soh.*;
...
public class CapabilitySohRollupModifier implements Modifier<Iterable<CapabilitySohRollup>> {
    ...
    private List<CapabilitySohRollup> groupCapabilityRollupList;
    ...
    public CapabilitySohRollupModifier(List<StationGroup> stationGroups) {
        ...
        this.groupCapabilityRollupList = new ArrayList<>();
    }
     ...
     */
    private List<CapabilitySohRollup> generateGroupCapabilityRollupsWithIDs(
        Map<String, StationSoh> stationSohMap) {
        List<CapabilitySohRollup> updatedList = new ArrayList<>();
    ...
    private Set<UUID> generateStationIDSet(StationGroup stationGroup,
        ...
        for (Station station : stationGroup.getStations()) {
            StationSoh stationSoh = stationSohMap.get(station.getName());
     ...
     */
    public List<CapabilitySohRollup> getGroupCapabilityRollupList() {
        return this.groupCapabilityRollupList;
    }
}
