...
public class DaoResponseConverter implements ResponseConverter {
  ...
  private DaoResponseConverter() {
  }

  /**
   * creates a new {@link DaoResponseConverter}
   *
   * @return a {@link DaoResponseConverter}
   */
  public static DaoResponseConverter create() {
    return new DaoResponseConverter();
  }
