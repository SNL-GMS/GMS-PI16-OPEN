...
class ResponseAssemblerTest {
  ...
  @BeforeEach
  void setup() {
    responseConverter = DaoResponseConverter.create();
    calibrationConverter = DaoCalibrationConverter.create();
    frequencyAmplitudePhaseConverter = FileFrequencyAmplitudePhaseConverter.create();
    responseAssembler = ResponseAssembler.create(responseConverter,
  ...
  void testCreateValidation(ResponseConverter responseConverter,
    CalibrationConverter calibrationConverter,
    FrequencyAmplitudePhaseConverter fapConverter) {
    assertThrows(NullPointerException.class,
      () -> ResponseAssembler.create(responseConverter, calibrationConverter, fapConverter));
  }

  static Stream<Arguments> getCreateArguments() {
    return Stream.of(arguments(null, mock(CalibrationConverter.class), mock(FrequencyAmplitudePhaseConverter.class)),
      arguments(mock(ResponseConverter.class), null, mock(FrequencyAmplitudePhaseConverter.class)),
      arguments(mock(ResponseConverter.class), mock(CalibrationConverter.class), null));
  }

  @Test
  void testCreate() {
    ResponseAssembler assembler = assertDoesNotThrow(() -> ResponseAssembler.create(responseConverter,
      calibrationConverter,
      frequencyAmplitudePhaseConverter));
  ...
  static Stream<Arguments> getBuildAllForTimeArguments() {
    ...
    return Stream.of(arguments(List.of(), Instant.EPOCH, List.of(), List.of(), List.of(), emptyChannelName),
      ...
      arguments(List.of(DaoResponseConverter.create().convert(WFDISC_TEST_DAO_1, SENSOR_DAO_1,
        DaoCalibrationConverter.create().convert(WFDISC_TEST_DAO_1, SENSOR_DAO_1),
        FileFrequencyAmplitudePhaseConverter.create().convertToEntityReference(Path.of(INSTRUMENT_DAO_1.getDirectory(),
