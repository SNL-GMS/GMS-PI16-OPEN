...
import static gms.shared.stationdefinition.testfixtures.CSSDaoTestFixtures.SITE_CHAN_DAO_NA_ENDTIME;
...
class DaoChannelConverterTest {
  ...
  private final DaoCalibrationConverter calibrationConverter = DaoCalibrationConverter.create();
  private DaoChannelConverter channelConverter;
  private ResponseConverterTransform responseConverterTransform;

  @BeforeEach
  void setUp() {
    channelConverter = DaoChannelConverter
  ...
  void testCreateChannelsFromDaosWithTransform_validationChecks(Class<? extends Exception> expectedException,
    ...
    assertThrows(expectedException,
      () -> channelConverter.convert(siteChanDao, siteDao, sensor, instrument, wfdiscDao, transform));
  }
  ...
  void testCreateChannelsFromDaos_nullResponse() {
    final Channel channel = assertDoesNotThrow(
      () -> channelConverter.convert(SITE_CHAN_DAO_1, SITE_DAO_1,
        CSSDaoTestFixtures.SENSOR_DAO_1, CSSDaoTestFixtures.INSTRUMENT_DAO_1, null, responseConverterTransform));
  ...
  @Test
  void testCreateChannelNAEffectiveUntil() {
    Channel channel = channelConverter.convert(SITE_CHAN_DAO_NA_ENDTIME, SITE_DAO_1, CSSDaoTestFixtures.SENSOR_DAO_1,
      CSSDaoTestFixtures.INSTRUMENT_DAO_1, CSSDaoTestFixtures.WFDISC_DAO_1, responseConverterTransform);

    assertTrue(channel.getEffectiveUntil().isEmpty());
  }
  ...
  void testCreateChannelsFromDaosWithTransform_nullResponse() {
    final Channel channel = assertDoesNotThrow(
      () -> channelConverter.convert(SITE_CHAN_DAO_1,
        CSSDaoTestFixtures.SITE_DAO_1, CSSDaoTestFixtures.SENSOR_DAO_1,
        CSSDaoTestFixtures.INSTRUMENT_DAO_1, null, responseConverterTransform));
