...
class FacetingDefinitionTest {
  ...
  protected FacetingDefinition getFacetingDefinition(
      String classType, Map<String, FacetingDefinition> facetedDefinitionMap) {
    return FacetingDefinition.builder().setClassType(classType).setFacetingDefinitions(facetedDefinitionMap).build();
  }
  ...
  protected FacetingDefinition getFacetingDefinition(
    ...
    return FacetingDefinition.builder().setClassType(classType)
        ...
        .setFacetingDefinitions(facetedDefinitionMap).build();
  }
