...
public class AffiliationDatabaseConnector extends DatabaseConnector {
  ...
  private AffiliationDatabaseConnector(EntityManagerFactory entityManagerFactory) {
    super(entityManagerFactory);
  }

  /**
   * Factory method for creating AffiliationRepositoryJpa
   *
   * @param entityManagerFactory EntityManagerFactory
   * @return AffiliationRepositoryJpa
   */
  public static AffiliationDatabaseConnector create(EntityManagerFactory entityManagerFactory) {
    checkNotNull(entityManagerFactory, "Cannot create AffiliationRepositoryJpa with null EntityManagerFactory");
