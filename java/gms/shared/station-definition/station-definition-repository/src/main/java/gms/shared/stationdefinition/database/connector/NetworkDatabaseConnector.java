...
public class NetworkDatabaseConnector extends DatabaseConnector {
  ...
  private NetworkDatabaseConnector(EntityManagerFactory entityManagerFactory) {
    super(entityManagerFactory);
  }

  /**
   * Factory method for creating NetworkRepositoryJpa
   *
   * @param entityManagerFactory EntityManagerFactory
   * @return NetworkRepositoryJpa
   */
  public static NetworkDatabaseConnector create(EntityManagerFactory entityManagerFactory) {
    checkNotNull(entityManagerFactory,
        "Cannot create NetworkRepositoryJpa with null EntityManagerFactory");
