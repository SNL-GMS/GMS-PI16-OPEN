...
public class SensorDatabaseConnector extends DatabaseConnector {
  ...
  private SensorDatabaseConnector(EntityManagerFactory entityManagerFactory) {
    super(entityManagerFactory);
  }

  /**
   * Factory method for creating SensorRepositoryJpa
   *
   * @param entityManagerFactory EntityManagerFactory
   * @return SensorRepositoryJpa
   */
  public static SensorDatabaseConnector create(EntityManagerFactory entityManagerFactory) {
    checkNotNull(entityManagerFactory, "Cannot create SensorRepositoryJpa with null EntityManagerFactory");
