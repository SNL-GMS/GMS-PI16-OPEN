...
class BridgedStationDefinitionAccessorTest {
  ...
  public void testSetup() {
    stationDefinitionAccessor = BridgedStationDefinitionAccessor.create(stationGroupRepository,
      stationRepository,
  ...
  void testCreate(StationGroupRepositoryInterface stationGroupRepository,
    ...
    assertThrows(NullPointerException.class, () -> BridgedStationDefinitionAccessor
      .create(stationGroupRepository,
        stationRepository,
        channelGroupRepository,
        channelRepository,
        responseRepository));
  ...
  static Stream<Arguments> getCreateArguments() {
    return Stream.of(
      arguments(null,
        mock(StationRepositoryInterface.class),
        mock(ChannelGroupRepositoryInterface.class),
        mock(ChannelRepositoryInterface.class),
        mock(ResponseRepositoryInterface.class)),
      arguments(mock(StationGroupRepositoryInterface.class),
        null,
        mock(ChannelGroupRepositoryInterface.class),
        mock(ChannelRepositoryInterface.class),
        mock(ResponseRepositoryInterface.class)),
