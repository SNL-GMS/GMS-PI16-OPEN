...
class RequestCachingStationDefinitionAccessorTest {
  ...
  void testCreateValidation(StationDefinitionAccessorInterface delegate, RequestCache requestCache) {
    assertThrows(NullPointerException.class,
      () -> RequestCachingStationDefinitionAccessor.create(delegate, requestCache));
  }

  static Stream<Arguments> getCreateArguments() {
    return Stream.of(
      arguments(null,
        mock(RequestCache.class)),
      arguments(mock(StationDefinitionAccessorInterface.class),
        null));
  }
  ...
  void findStationGroupsByNameAndTimeHitTest() {
    StationDefinitionAccessorInterface requestCacheAccessor = RequestCachingStationDefinitionAccessor.create(delegate, cache);
