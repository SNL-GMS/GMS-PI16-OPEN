...
public class AutomaticIntervalConverter {
  ...
  private ProcessingSequenceInterval buildSequenceFromTemplate(
    ...
    if (IntervalStatus.COMPLETE.equals(intervalStatus)) {
      ...
      intervalBuilder
        .setLastExecutedStepName(findLastExecutedStep(sequence, currentStep))
  ...
  private static String findLastExecutedStep(ProcessingSequence sequence, String currentStep) {
    ...
    return currentStepIndex == 0 ? "" : stepNames.get(currentStepIndex - 1);
  }
  ...
  private static double calculatePercentComplete(ProcessingSequence sequence, String currentStep) {
    ...
    return 100.0 * currentStepIndex / stepNames.size();
  }
}
