...
public class IntervalUtility {
  ...
  private static InteractiveAnalysisStageInterval openInteractiveStageInterval(InteractiveAnalysisStageInterval interval, String analyst) {
  ...
  private static InteractiveAnalysisStageInterval closeInteractiveStageInterval(InteractiveAnalysisStageInterval interval, String analyst) {
  ...
  private static InteractiveAnalysisStageInterval completeInteractiveStageInterval(InteractiveAnalysisStageInterval interval) {
  ...
  static InteractiveAnalysisStageInterval closeActivityInterval(
    ...
    // If all ActivityIntervals are NOT_COMPLETE, set the StageInterval status to NOT_COMPLETE
    var activityIntervalsStillOpen = activityIntervals.stream()
        .filter(ai ->
          !ai.getStatus().equals(IntervalStatus.NOT_COMPLETE) && !ai.getStatus().equals(IntervalStatus.NOT_STARTED)
        ).count();

    if (activityIntervalsStillOpen == 0) {
