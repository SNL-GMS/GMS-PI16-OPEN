...
public class IntervalFixtures {
  ...
  static final String ACTIVITY_1_NAME = "activity1";
  static final String ACTIVITY_2_NAME = "activity2";
  static final String ANALYST_1 = "analyst1";
  static final String ANALYST_2 = "analyst2";

  static final Instant START_TIME = Instant.EPOCH;
  static final Instant END_TIME = START_TIME.plusSeconds(1);

  static final IntervalId activityInterval1Id = IntervalId.from(START_TIME,
    WorkflowDefinitionId.from(ACTIVITY_1_NAME));

  static final IntervalId activityInterval2Id = IntervalId.from(START_TIME,
  ...
  static final ActivityInterval notStartedActivityInterval2 = ActivityInterval.builder()
