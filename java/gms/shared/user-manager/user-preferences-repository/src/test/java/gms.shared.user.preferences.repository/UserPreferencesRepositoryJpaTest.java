...
import gms.shared.user.preferences.repository.util.DbTest;
...
class UserPreferencesRepositoryJpaTest extends DbTest {
    ...
    UserPreferences userPreferences = UserPreferences
        .from(this.userId,
            ...
            List.of(WorkspaceLayout
                .from("Default Layout", List.of(UserInterfaceMode.ANALYST), "Test " +
                    "Configuration")), new ArrayList<>());

    UserPreferencesRepositoryJpa userPreferencesRepository =
        UserPreferencesRepositoryJpa.create(entityManagerFactory);
  ...
  void getUserPreferencesByUserId() {
    UserPreferences userPreferences = UserPreferences
        .from(this.userId,
            ...
            "Default Layout",
            List.of(WorkspaceLayout
                .from("Default Layout", List.of(
                    UserInterfaceMode.ANALYST), "Test " +
  ...
  void setUserPreferences_updateNotifications() {
    ...
    final var audibleNotificationsUpdate = List.of(
        AudibleNotification
            .from("Hey.wav", SystemMessageType.STATION_CAPABILITY_STATUS_CHANGED),
        AudibleNotification
            .from("Hush.wav", SystemMessageType.CHANNEL_MONITOR_TYPE_QUIETED),
        AudibleNotification
            .from("WatchOut.wav", SystemMessageType.STATION_NEEDS_ATTENTION));
    UserPreferences userPreferencesUpdate = UserPreferences
        .from(this.userId,
            "Default Layout",
            "Default Layout",
            List.of(WorkspaceLayout
  ...
  void getUserPreferencesByUserId_withNotifications() {
    ...
    UserPreferences userPreferences =
        UserPreferences.from(this.userId,
            "Default Layout",
            "Default Layout",
