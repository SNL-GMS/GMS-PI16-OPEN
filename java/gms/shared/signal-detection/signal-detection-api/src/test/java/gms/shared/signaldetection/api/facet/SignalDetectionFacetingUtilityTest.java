...
class SignalDetectionFacetingUtilityTest {
  ...
  private static List<SignalDetectionId> unpopulatedDetectionId = List.of(unpopulatedDetection.getId());
  ...
  static Stream<Arguments> getPopulateFacetsValidationSdArguments() {
    ...
    return Stream.of(
      ...
      arguments(NoSuchElementException.class,
        "Retrieved data is not populated",
      ...
      arguments(IllegalStateException.class,
        ...
        signalDetectionFacetingDefinition.toBuilder()
          .setFacetingDefinitions(Map.of("station", stationFacetingDefinition,
            "signalDetectionHypotheses", signalDetectionHypothesisFacetingDefinition.toBuilder()
              .setPopulated(false)
  ...
  static Stream<Arguments> getPopulateFacetsValidationSdhArguments() {
    Consumer<SignalDetectionAccessorInterface> noResultSetup = signalDetectionAccessor ->
      when(signalDetectionAccessor.findHypothesesByIds(unpopulatedHypothesisId))
        .thenReturn(List.of());
    Consumer<SignalDetectionAccessorInterface> noResultVerifier = signalDetectionAccessor ->
      verify(signalDetectionAccessor).findHypothesesByIds(unpopulatedHypothesisId);

    Consumer<SignalDetectionAccessorInterface> multipleResultSetup = signalDetectionAccessor ->
      when(signalDetectionAccessor.findHypothesesByIds(unpopulatedHypothesisId))
        .thenReturn(List.of(SIGNAL_DETECTION_HYPOTHESIS, HYPOTHESIS_FROM_ARRIVAL_1));
    Consumer<SignalDetectionAccessorInterface> multipleResultVerifier = signalDetectionAccessor ->
      verify(signalDetectionAccessor).findHypothesesByIds(unpopulatedHypothesisId);

    Consumer<SignalDetectionAccessorInterface> singleResultSetup = signalDetectionAccessor ->
      when(signalDetectionAccessor.findHypothesesByIds(unpopulatedHypothesisId))
        .thenReturn(List.of(unpopulatedHypothesis));
    Consumer<SignalDetectionAccessorInterface> singleResultVerifier = signalDetectionAccessor ->
      verify(signalDetectionAccessor).findHypothesesByIds(unpopulatedHypothesisId);
