...
public class RequestCachingSignalDetectionAccessor implements SignalDetectionAccessorInterface {
  ...
  private RequestCachingSignalDetectionAccessor(RequestCache requestCache, SignalDetectionAccessorInterface delegate) {
    this.requestCache = requestCache;
    this.delegate = delegate;
  }

  public static RequestCachingSignalDetectionAccessor create(RequestCache requestCache,
    SignalDetectionAccessorInterface delegate) {

    Objects.requireNonNull(requestCache);
    Objects.requireNonNull(delegate);

    return new RequestCachingSignalDetectionAccessor(requestCache, delegate);
  }
  ...
  @Override
  public List<SignalDetection> findByIds(List<SignalDetectionId> ids, WorkflowDefinitionId stageId, FacetingDefinition facetingDefinition) {
    Objects.requireNonNull(ids, NULL_IDS_MESSAGE);
    Objects.requireNonNull(stageId, NULL_STAGE_ID_MESSAGE);
