...
public abstract class SignalDetectionHypothesisConverterId {
  ...
  @JsonCreator
  public static SignalDetectionHypothesisConverterId from(@JsonProperty("stageId") String stageId,
    @JsonProperty("detectionId") UUID detectionId,
    @JsonProperty("parentId)") Optional<UUID> parentId) {
    return new AutoValue_SignalDetectionHypothesisConverterId(stageId, detectionId, parentId);
  }
}
