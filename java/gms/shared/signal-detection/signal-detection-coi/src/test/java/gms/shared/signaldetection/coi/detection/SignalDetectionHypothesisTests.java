...
class SignalDetectionHypothesisTests {
  ...
  void testNoArrivalTimeFeatureMeasurement() {
    ...
    SignalDetectionHypothesis.Data.Builder dataBuilder = SignalDetectionHypothesis.Data.builder()
      .setMonitoringOrganization(monitoringOrganization)
      .setStation(UtilsTestFixtures.STATION)
      .setParentSignalDetectionHypothesisId(Optional.of(id4))
      .setRejected(NOT_REJECTED)
  ...
  void testBuilderSetMeasurementsThenAddMeasurement() {
    SignalDetectionHypothesis.Data data = SignalDetectionHypothesis.Data.builder()
      .setMonitoringOrganization(monitoringOrganization)
      .setStation(UtilsTestFixtures.STATION)
      .setParentSignalDetectionHypothesisId(Optional.of(UUID.randomUUID()))
      .setRejected(NOT_REJECTED)
    ...
    SignalDetectionHypothesis signalDetectionHypothesis = SignalDetectionHypothesis.builder()
      .setId(SignalDetectionHypothesisId.from(UUID.randomUUID(), UUID.randomUUID()))
      .setData(Optional.of(data)).build();

    assertDoesNotThrow(() -> {
      signalDetectionHypothesis.getData().orElseThrow().toBuilder()
        .setFeatureMeasurements(ImmutableSet.copyOf(featureMeasurements))
        .addMeasurement(SignalDetectionTestFixtures.PHASE_FEATURE_MEASUREMENT)
        .build();
    });
  }
