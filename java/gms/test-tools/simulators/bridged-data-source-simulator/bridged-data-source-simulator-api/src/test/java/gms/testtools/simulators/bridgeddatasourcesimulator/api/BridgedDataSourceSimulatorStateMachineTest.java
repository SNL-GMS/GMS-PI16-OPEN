...
class BridgedDataSourceSimulatorStateMachineTest {
  ...
  private static class TestSimulatorStateMachine extends BridgedDataSourceSimulatorStateMachine {
    public TestSimulatorStateMachine() {
      super();
    }
  }

  private TestSimulatorStateMachine simulatorManager;

  @BeforeEach
  void testSetup() {
    simulatorManager = new TestSimulatorStateMachine();
  }
  ...
  @Test
  void testInitialize_thenVerifyCleanup() {
    runValidInitialize();
