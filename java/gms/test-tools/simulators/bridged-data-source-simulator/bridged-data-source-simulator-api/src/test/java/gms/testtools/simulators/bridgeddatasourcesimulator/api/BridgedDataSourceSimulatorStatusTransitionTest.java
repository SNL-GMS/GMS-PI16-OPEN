...
class BridgedDataSourceSimulatorStatusTransitionTest {
  ...
  void testStateTransitions(
      BridgedDataSourceSimulatorTransition transition, BridgedDataSourceSimulatorStatus currentState,
  ...
  private static Stream<Arguments> statusTransitionsArguments() {
    return Stream.of(
        ...
        Arguments.arguments(INITIALIZE, UNINITIALIZED, INITIALIZED, true),
