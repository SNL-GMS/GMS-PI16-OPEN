...
public abstract class BridgedDataSourceSimulatorStateMachine implements
  ...
  protected BridgedDataSourceSimulatorStateMachine() {
  ...
  protected void verifyInitializeTransition(BridgedDataSourceSimulatorSpec bridgedDataSourceSimulatorSpec) {
    Validate.notNull(bridgedDataSourceSimulatorSpec, "A Simulator Spec must be provided");
    validateStatusTransition(INITIALIZED, BridgedDataSourceSimulatorTransition.INITIALIZE);
  }
  ...
  protected void verifyStartTransition() {
  ...
  protected void verifyStopTransition() {
  ...
  protected void verifyCleanupTransition() {
  ...
  protected void verifyStatusTransitionWasVerified(BridgedDataSourceSimulatorTransition statusTransition) {
  ...
  public enum BridgedDataSourceSimulatorTransition {
    ...
    INITIALIZE(List.of(UNINITIALIZED), INITIALIZED),
