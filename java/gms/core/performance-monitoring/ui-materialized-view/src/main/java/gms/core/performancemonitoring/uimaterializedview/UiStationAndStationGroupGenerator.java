...
public class UiStationAndStationGroupGenerator {
   ...
   * @param unacknowledgedStatusChanges - Current unacknowledged channel/monitor pairs managed by
   * UnacknowledgedSohListManager
   * @param quietedSohStatusChanges - Current quieted soh status list managed by SohStationConsumer
  ...
  public static synchronized List<UiStationAndStationGroups> generateUiStationAndStationGroups(
    ...
    List<CapabilitySohRollup> latestCapabilitySohRollups,
    ...
    Objects.requireNonNull(unacknowledgedStatusChanges);
    Objects.requireNonNull(quietedSohStatusChanges);
