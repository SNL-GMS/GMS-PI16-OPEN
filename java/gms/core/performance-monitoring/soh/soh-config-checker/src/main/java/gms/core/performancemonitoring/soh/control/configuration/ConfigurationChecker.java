...
public class ConfigurationChecker {
  ...
  private static void printStatistics(StationSohMonitoringDefinition definition) {
    ...
    System.out.println("MAX INTERVALS===========================================");
    configurationAnalyzer.stationMaxCalculationInterval().forEach((k, v) -> {

      System.out.printf("Station %s max calculation interval %s%n", k, v);
    });

    System.out.println("MAX INTERVALS===========================================");

    configurationAnalyzer.stationMaxBackoffDuration().forEach((k, v) -> {

      System.out.printf("Station %s max backoff duration %s%n", k, v);
    });
  }
}
