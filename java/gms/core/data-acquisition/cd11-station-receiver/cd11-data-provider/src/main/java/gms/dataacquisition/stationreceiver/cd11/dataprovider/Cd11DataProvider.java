...
class Cd11DataProvider {
  ...
  public static void main(String[] args) {
    ...
    var clientFactory = Cd11ClientFactory
      .create(providerConfig.getFrameCreator().orElse("DATAPROV"),
        providerConfig.getFrameDestination().orElse("C0NNMAN"));
    ...
    Disposable disposable = framePublisher.publish(source).subscribe();
