...
public class Cd11FrameFactory {
  ...
  private Cd11Frame wrapPayload(FrameType type, Cd11Payload payload, long sequenceNumber) {
    ...
    Cd11Trailer frameTrailer = createFrameTrailer(frameHeaderAndBodyByteBuffer.array());
