...
public class Cd11FrameReader {
   ...
   * @throws ParseCd11FromByteBufferException if there were any overflow/underflow exceptions when reading from the byte buffer
   */
  public static Cd11OrMalformedFrame readFrame(ByteBuffer buf) {
    ...
    try {
      ...
      PartialFrame.Builder partialBuilder = PartialFrame.builder();
