...
public abstract class CoiDataGenerator<T, M extends Modifier<?>> implements Runnable {
   ...
   */
  public CoiDataGenerator(GenerationSpec generationSpec, OsdRepositoryInterface sohRepository) {
                ...
                if (generationSpec.getType()
                  ...
                  return Flux
                      ...
                      .map(t -> {
                        ...
                        GenerationSpec.Builder generationSpecBuilder = generationSpec.toBuilder();
                        generationSpecBuilder.setAcquiredChannelEnvironmentIssueType(t);
                        final GenerationSpec generationSpecCopy = generationSpecBuilder.build();
