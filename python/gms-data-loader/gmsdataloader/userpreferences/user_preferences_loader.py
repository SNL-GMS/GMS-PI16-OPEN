...
class UserPreferencesLoader:
    ...
    def __init__(self, config: UserPreferencesLoaderConfig, total_retries: Optional[int] = 10):
        """
        Constructor
    ...
    def load_user_preferences(self, user_preferences_path: str):
        """
    ...
    def load(self, user_prefs_obj_paths: UserPreferencesObjectPaths):
        """
